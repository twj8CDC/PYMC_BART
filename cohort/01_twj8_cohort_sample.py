...
TABLE = "cdh_premier_exploratory.twj8_pat_covid_tf_02"
if WRITE:
    (
        pat_covid_tf
        .write
...
if WRITE:
    TABLE = "cdh_premier_exploratory.twj8_pat_noncovid_03"
...
if WRITE:
    TABLE = "cdh_premier_exploratory.twj8_pat_cov_noncov_04"
...
if WRITE:
    TABLE = "cdh_premier_exploratory.twj8_pat_cov_noncov_excl_04"
...
###############################################################################
if WRITE:
    table = "cdh_premier_exploratory.twj8_pat_cov_noncov_final_05"
...
if WRITE:
    table = "cdh_premier_exploratory.twj8_pat_ccsr_long_06"
    cc3_long.write.mode("overwrite").format("delta").saveAsTable(table)
    cc3_long = spark.table(table)
    cc3_long.count()
    table = "cdh_premier_exploratory.twj8_pat_ccsr_short_06"
...
cov_final = (
    cov1
    .join(cov5, on = "medrec_key", how="left")
)
...
if WRITE:
    table = "cdh_premier_exploratory.twj8_pat_covariates_06"
    cov_final.write.mode("overwrite").format("delta").saveAsTable(table)
