...
trn_ncov_pos = np.unique(trn["y_sk_coh"][trn["x_sk_coh"][:,5] == 0]["Status"], return_counts=True)
tst_cov_pos = np.unique(tst["y_sk_coh"][tst["x_sk_coh"][:,5] == 1]["Status"], return_counts=True)
tst_ncov_pos = np.unique(tst["y_sk_coh"][tst["x_sk_coh"][:,5] == 1]["Status"], return_counts=True)
